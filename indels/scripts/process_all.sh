...
#$acids/scripts/count_one_fraction.sh ../../fastq_reads/eGFPN-R1.fastq.gz ../../fastq_reads/eGFPN-R2.fastq.gz ../../references/eGFP.fa eGFP N
##
#$acids/scripts/count_one_fraction.sh ../../fastq_reads/GFP8L-R1.fastq.gz ../../fastq_reads/GFP8L-R2.fastq.gz ../../references/GFP8.fa GFP8 L
##$acids/scripts/count_one_fraction.sh ../../fastq_reads/GFP8H-R1.fastq.gz ../../fastq_reads/GFP8H-R2.fastq.gz ../../references/GFP8.fa GFP8 H
#$acids/scripts/count_one_fraction.sh ../../fastq_reads/GFP8MM-R1.fastq.gz ../../fastq_reads/GFP8MM-R2.fastq.gz ../../references/GFP8.fa GFP8 MM
#$acids/scripts/count_one_fraction.sh ../../fastq_reads/GFP8N-R1.fastq.gz ../../fastq_reads/GFP8N-R2.fastq.gz ../../references/GFP8.fa GFP8 N
